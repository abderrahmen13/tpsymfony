 ...
 */
final class Version20210101225913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D6495E9E89CB ON user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D6495E9E89CB ON user (location)');
    }
}
